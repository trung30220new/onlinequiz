...
urlpatterns = [
    ...
    path('logout',
         LogoutView.as_view(template_name='quiz/logout.html'),
         name='logout'),
    ...
    path('approve-teacher/<int:pk>',
         views.approve_teacher_view,
         name='approve-teacher'),
    path('reject-teacher/<int:pk>',
         views.reject_teacher_view,
         name='reject-teacher'),
    ...
    path('admin-add-course',
         views.admin_add_course_view,
         name='admin-add-course'),
    path('admin-view-course',
         views.admin_view_course_view,
